...
contract DSCEngine is ReentrancyGuard {
    ...
    event CollateralDeposited(address indexed user, address indexed token, uint256 indexed
     amount);
    event CollateralReedemed( address indexed token, uint256 amount,address indexed redeemFrom,address indexed redeemTo );
    ///////////////////
    ////   Modifier   //
    ///////////////////
...
function depositCollateralAndMintDsc(
    ...
    function getAccountInformation(address user) public  view returns(
        uint256 totalDscMinted,
        uint256 collateralValueInUsd){
